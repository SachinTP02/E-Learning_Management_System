...
return false;
			...
			<form class="form-horizontal login-form" action="" method="post" name="form">
			  ...
			  <div class="form-group">
			    <button type="submit" class="btn btn-success btn-lg btn-block" onclick="ValidateEmail(document.form.username)">Login</button>
			  </div>
        <div class="checkbox pull-left ">
			    <label> <a class="forget" href="forgot2.php" title="forget">Forgot Password</a> </label>
			  </div><br>
        <div class="checkbox pull-left ">
			    <label> <a class="forget" href="admin.php" title="forget">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Login as Teacher</a> </label>
			  </div><br>
        <div class="checkbox pull-left ">
			    <label> <a class="forget" href="root.php" title="forget">Login as Admin</a> </label>
			  </div>
