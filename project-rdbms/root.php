...
<?php
	...
	{	
        ...
        $result = mysqli_query($con,"SELECT email FROM root WHERE email = '$email' and password = '$password'") or die('Error');
...
<body class="login">
	<div class="container">
		<div class="login-container-wrapper clearfix">
			...
			<div class="welcome"><strong>Welcome,</strong> Admin login</div>
